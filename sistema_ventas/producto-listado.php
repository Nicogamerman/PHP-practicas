        ...
        <div class="container-fluid">
          ...
          <table class="table table-hover border">
            ...
            <?php foreach ($aTipoProductos as $tipoProducto): ?>
              <tr>
                  <td><?php echo $tipoProducto->cuit; ?></td>
                  <td><?php echo $tipoProducto->nombre; ?></td>
                  <td><?php echo date_format(date_create($tipoProducto->fecha_nac), "d/m/Y"); ?></td>
                  <td><?php echo $tipoProducto->telefono; ?></td>
                  <td><?php echo $tipoProducto->correo; ?></td>
